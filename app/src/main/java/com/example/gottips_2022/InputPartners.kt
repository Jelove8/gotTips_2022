...
class InputPartners : Fragment() {
    ...
    private fun calculateSumHours() {
        ...
        viewModel.setTotalHours(currentSumHours.toString())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.partner1.setText(viewModel.getNames()?.get(0))
        binding.partner2.setText(viewModel.getNames()?.get(1))
        binding.partner3.setText(viewModel.getNames()?.get(2))
        binding.partner4.setText(viewModel.getNames()?.get(3))
        binding.partner5.setText(viewModel.getNames()?.get(4))
        binding.partner6.setText(viewModel.getNames()?.get(5))
        binding.partner7.setText(viewModel.getNames()?.get(6))
        binding.partner8.setText(viewModel.getNames()?.get(7))
        binding.partner9.setText(viewModel.getNames()?.get(8))
        binding.partner10.setText(viewModel.getNames()?.get(9))
        binding.partner11.setText(viewModel.getNames()?.get(10))
        binding.partner12.setText(viewModel.getNames()?.get(11))
        binding.partner13.setText(viewModel.getNames()?.get(12))
        binding.partner14.setText(viewModel.getNames()?.get(13))
        binding.partner15.setText(viewModel.getNames()?.get(14))
        binding.partner16.setText(viewModel.getNames()?.get(15))
        binding.partner17.setText(viewModel.getNames()?.get(16))
        binding.partner18.setText(viewModel.getNames()?.get(17))
        binding.partner19.setText(viewModel.getNames()?.get(18))
        binding.partner20.setText(viewModel.getNames()?.get(19))
        binding.partner21.setText(viewModel.getNames()?.get(20))
        binding.partner22.setText(viewModel.getNames()?.get(21))
        binding.partner23.setText(viewModel.getNames()?.get(22))
        binding.partner24.setText(viewModel.getNames()?.get(23))
        binding.partner25.setText(viewModel.getNames()?.get(24))
        binding.partner26.setText(viewModel.getNames()?.get(25))
        binding.partner27.setText(viewModel.getNames()?.get(26))
        binding.partner28.setText(viewModel.getNames()?.get(27))
        binding.partner29.setText(viewModel.getNames()?.get(28))
        binding.partner30.setText(viewModel.getNames()?.get(29))

        binding.hours1.setText(viewModel.getHours()?.get(0))
        binding.hours2.setText(viewModel.getHours()?.get(1))
        binding.hours3.setText(viewModel.getHours()?.get(2))
        binding.hours4.setText(viewModel.getHours()?.get(3))
        binding.hours5.setText(viewModel.getHours()?.get(4))
        binding.hours6.setText(viewModel.getHours()?.get(5))
        binding.hours7.setText(viewModel.getHours()?.get(6))
        binding.hours8.setText(viewModel.getHours()?.get(7))
        binding.hours9.setText(viewModel.getHours()?.get(8))
        binding.hours10.setText(viewModel.getHours()?.get(9))
        binding.hours11.setText(viewModel.getHours()?.get(10))
        binding.hours12.setText(viewModel.getHours()?.get(11))
        binding.hours13.setText(viewModel.getHours()?.get(12))
        binding.hours14.setText(viewModel.getHours()?.get(13))
        binding.hours15.setText(viewModel.getHours()?.get(14))
        binding.hours16.setText(viewModel.getHours()?.get(15))
        binding.hours17.setText(viewModel.getHours()?.get(16))
        binding.hours18.setText(viewModel.getHours()?.get(17))
        binding.hours19.setText(viewModel.getHours()?.get(18))
        binding.hours20.setText(viewModel.getHours()?.get(19))
        binding.hours21.setText(viewModel.getHours()?.get(20))
        binding.hours22.setText(viewModel.getHours()?.get(21))
        binding.hours23.setText(viewModel.getHours()?.get(22))
        binding.hours24.setText(viewModel.getHours()?.get(23))
        binding.hours25.setText(viewModel.getHours()?.get(24))
        binding.hours26.setText(viewModel.getHours()?.get(25))
        binding.hours27.setText(viewModel.getHours()?.get(26))
        binding.hours28.setText(viewModel.getHours()?.get(27))
        binding.hours29.setText(viewModel.getHours()?.get(28))
        binding.hours30.setText(viewModel.getHours()?.get(29))
    ...
    override fun onDestroyView() {
        ...
        viewModel.setHours(currentListOfHours)
        viewModel.setTotalHours(binding.outputTotalHours.text.toString())
    }
